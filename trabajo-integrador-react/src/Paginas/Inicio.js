...
{seriesPopulares.map(serie => (<ItemListSeriePopular serie={serie}/>))}
            </section>

            <section className="lista-cartelera">
                <h2 className="h2-titulos">Popular movies</h2>

{peliculasPopulares.map(pelicula => (<ItemListPeliculaPopular pelicula={pelicula}/>))}

            </section>


            <section className="lista-cartelera-peliculas-vistas">
                <h2 className="h2-titulos">Top rated movies</h2>
